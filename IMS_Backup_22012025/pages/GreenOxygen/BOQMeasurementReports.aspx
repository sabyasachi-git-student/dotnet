<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOQMeasurementReports.aspx.cs" Inherits="pages_GreenOxygen_BOQMeasurementReports" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col-sm-12" align="center">
                                <div class="col-sm-6">
                                    <h3 class="card-title" style="font-size: 35px;">BOQ Measurement Reports</h3>
                                </div>
                            </div>
                        </div>
