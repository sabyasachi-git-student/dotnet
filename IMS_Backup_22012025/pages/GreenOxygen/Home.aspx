<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="pages_GreenOxygen_Home" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col-sm-12" align="center">
                                <div class="col-sm-6">
                                    <h3 class="card-title" style="font-size: 35px;">Welcome to Railtel Corporation</h3>
                                </div>
                            </div>
