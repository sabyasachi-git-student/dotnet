<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOQExtraWorkFilesDownload.aspx.cs" Inherits="pages_GreenOxygen_BOQExtraWorkFilesDownload" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col-sm-12" align="center">
                                <div class="col-sm-6">
                                    <h3 class="card-title" style="font-size: 35px;">BOQ Extra Work Files Downloads</h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="card-body" style=" overflow:auto;">
                                        ...
                                        <dx:ASPxGridView ID="gvMeasurFileDownload" runat="server" Width="100%" Theme="Office2003Blue" AutoGenerateColumns="False" KeyFieldName="EXTRWRID" DataSourceID="MeasurFileDownload" OnRowCommand="gvMeasurFileDownload_RowCommand">
                                            <Columns>
                                                <dx:GridViewDataTextColumn Caption="Download Doc"  Width="0px">
                                                    <DataItemTemplate>
                                                        <asp:Button runat="server" ID="btnView" Text="Download" BackColor="Gray" ForeColor="White" CommandName="Download" CommandArgument='<%#Eval("EXTRWRID")%>' />
                                                    </DataItemTemplate>
                                                ...
                                                <dx:GridViewDataDateColumn FieldName="UserDate" Caption="Date">
                                        ...
                                        <asp:SqlDataSource ID="MeasurFileDownload" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select * from [dbo].[tbl_BOQExtraWorkMain]  where  convert(datetime,UserDate,103) between convert(datetime,@FromDate,103) and convert(datetime,@ToDate,103)">
