<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOQMeasurementFileDownload.aspx.cs" Inherits="pages_GreenOxygen_BOQMeasurementFileDownload" %>
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-10">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <asp:DropDownList runat="server" ID="ddl_Project" class="form-control select2" Style="width: 100%; height: 40px;" DataValueField="BranchId" DataTextField="BranchName" AutoPostBack="true"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col-sm-12" align="center">
                                <div class="col-sm-6">
                                    <h3 class="card-title" style="font-size: 35px;">BOQ Measurement Downloads</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <dx:ASPxDateEdit ID="txtFromDate" DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy" runat="server" Height="40px" Width="100%">
                                            </dx:ASPxDateEdit>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                            ...
                                            <dx:ASPxDateEdit ID="txtToDate" DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy" runat="server" Height="40px" Width="100%">
                                            </dx:ASPxDateEdit>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="card-body" style=" overflow:auto;">
                                        ...
                                        <dx:ASPxGridView ID="gvMeasurFileDownload" runat="server" Width="100%" Theme="Office2003Blue" AutoGenerateColumns="False" KeyFieldName="BOQDetailsID" DataSourceID="MeasurFileDownload" OnRowCommand="gvMeasurFileDownload_RowCommand">
                                            <Columns>
                                                <dx:GridViewDataTextColumn Caption="Download Doc"  Width="0px">
                                                    <DataItemTemplate>
                                                        <asp:Button runat="server" ID="btnView" Text="Download" BackColor="Gray" ForeColor="White" CommandName="Download" CommandArgument='<%#Eval("BOQDetailsID")%>' />
                                                    </DataItemTemplate>
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn FieldName="BOQName" >
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn FieldName="Srno" >
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn FieldName="ItemDescription" >
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataDateColumn FieldName="UserDate" >
                                        ...
                                        <asp:SqlDataSource ID="MeasurFileDownload" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="SELECT * FROM [tbl_BOQDetail_New]  where  ProjectId= @ProjectId and  convert(datetime,UserDate,103) between convert(datetime,@FromDate,103) and convert(datetime,@ToDate,103)">
