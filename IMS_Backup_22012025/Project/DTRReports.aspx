<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="DTRReports.aspx.cs" Inherits="Project_DTRReports" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">DMTR Reports</h3>
            </div>
            <br />
            ...
            <div align="center">
               ...
               <div align="center">
                <table>
                    ...
                    <tr>
                        <td>
                            <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridView2"></dx:ASPxGridViewExporter>
                    ...
                    <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="ItemName" Caption="Item Name" ReadOnly="True" VisibleIndex="4">
                             ...
                             <dx:GridViewDataTextColumn FieldName="Make" Caption="Make" ReadOnly="True" VisibleIndex="4">
                            </dx:GridViewDataTextColumn>
                             <dx:GridViewDataTextColumn FieldName="Model" Caption="Model" ReadOnly="True" VisibleIndex="4">
                            </dx:GridViewDataTextColumn>
