<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="MaterialReceive.aspx.cs" Inherits="Project_MaterialReceive" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Material Receive</h3>
            </div>
            <br />
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="ddlIssueId" runat="server"
                                DataSourceID="SqlDataSource2" Height="30px" Width="250px" TextFormatString="{0}"
                                ValueField="Issueid" TextField="Issueid" Theme="Office2003Blue" AutoPostBack="true" OnTextChanged="ddlIssueId_TextChanged"
                                IncrementalFilteringMode="Contains" CallbackPageSize="10" EnableCallbackMode="True" DropDownStyle="DropDown">
                                <Columns>
                                    <dx:ListBoxColumn Caption="Issue id" FieldName="Issueid" />
                                    <dx:ListBoxColumn Caption="Req Id" FieldName="ReqId" />
                                </Columns>
                            </dx:ASPxComboBox>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                ConnectionString="<%$ ConnectionStrings:Profit %>"
                                SelectCommand="select distinct Issueid, ReqId from tbl_MaterialIssue where Issueid in (select Issueid from tbl_MaterialShipment) and IssueId not in (Select IssueId from [tbl_MaterialReceive]) and ReUserId=@BranchName Union all 
select distinct TemIssueId as IssueId, ReqId from tbl_TemporaryStockIssue where TemIssueId in (select Issueid from tbl_MaterialShipment) and TemIssueId  not in (Select IssueId from [tbl_MaterialReceive]) and ReUserId=@BranchName">
                                <SelectParameters>
                                    <asp:SessionParameter Name="BranchName" SessionField="BranchName" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="ddlCourierName" runat="server" Enabled="false"
                                DataSourceID="SqlDataSource3" Height="30px" Width="250px"
                                ValueField="CourierName" TextField="CourierName" Theme="Office2003Blue"
                                IncrementalFilteringMode="Contains" CallbackPageSize="10" EnableCallbackMode="True" DropDownStyle="DropDown">
                            </dx:ASPxComboBox>
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                ConnectionString="<%$ ConnectionStrings:Profit %>"
                                SelectCommand="select Distinct CourierName from tbl_MaterialShipment"></asp:SqlDataSource>
                        </td>
                        <td style="font-weight: bold;">Consignment Number : </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtConsignmentNumber" Enabled="false" Height="30px" Width="250px"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtContactNo" Enabled="false" Height="30px" Width="250px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-weight: bold;">Train Name : </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtTrainName" Enabled="false" Height="30px" Width="250px"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold;">Train No : </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtTrainNo" Enabled="false" Height="30px" Width="250px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-weight: bold;">Coach No : </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtCoachNo" Enabled="false" Height="30px" Width="250px"></asp:TextBox>
                        </td>
                    ...
                    <tr style="visibility: hidden">
                        ...
                        <td>
                            <dx:ASPxDateEdit ID="dtpCourierDate" Enabled="false" DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy" runat="server" Height="30px" Width="250px">
                            </dx:ASPxDateEdit>
                        </td>
                    </tr>
                </table>
                ...
                <br />
                <div align="center">
                    <asp:GridView ID="gv_Barc" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnRowCommand="gv_Barc_RowCommand" OnRowDeleting="gv_Barc_RowDeleting" OnRowEditing="gv_Barc_RowEditing" OnPageIndexChanging="gv_Barc_PageIndexChanging" Width="100%" PageSize="100">
                        <Columns>
                ...
                <table>
                    <tr>
                        ...
                        <td colspan="4" align="center">
                            <asp:Button runat="server" ID="btnSave" OnClick="btnSave_Click" Text="Save" CssClass="w3-btn w3-green" />
