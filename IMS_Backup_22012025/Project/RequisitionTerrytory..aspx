<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionTerrytory..aspx.cs" Inherits="Project_RequisitionTerrytory_" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Material Requisition Of Territory</h3>
            </div>
            <br />
            ...
            <div align="center" runat="server" id="tblApp" visible="false">
                <table cellspacing="15px" align="center">
                    ...
                    <tr style="visibility:hidden" >
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtPopId" Enabled="false" Height="30px" Style="resize: none" Width="250px"></asp:TextBox>
                        </td>
                ...
                <div align="center">
                    <asp:GridView ID="gvItemDetailsApp" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReqPopItemId" HeaderText="ReqItemId"/>
                            ...
                            <asp:TemplateField HeaderText="Req Qty">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtRate" runat="server" Width="70px" Text='<%#Eval("Qty") %>' Font-Bold="False" Enabled="false" ></asp:TextBox>

                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="App & Issue Qty">
                                <ItemTemplate>
                                    <asp:TextBox runat="server" ID="txtItemQty" Width="70px" Enabled="false" Text='<%#Eval("Qty") %>'></asp:TextBox>
                 ...
                 <table>
                    <tr runat="server" id="row_wantstoF" visible="false">
                        <td>
                            <asp:Button runat="server" ID="btn_WantsToForword" OnClick="btn_WantsToForword_Click" Text="Wants to Forword"  CssClass="w3-btn w3-red" />
                            <asp:CheckBox runat="server" ID="ChkFor" AutoPostBack="true" OnCheckedChanged="ChkFor_CheckedChanged" Visible="false" />
                        </td>
                    </tr>
                </table>
            </div>
                        ...
                        <td>
                             <asp:DropDownList runat="server" ID="ddlRequToGrp" AutoPostBack="true" OnTextChanged="ddlRequToGrp_TextChanged" Theme="Office2003Blue" Style="font-size: small;" Height="30px" Width="250px">
                                <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                  <asp:ListItem Text="RegionalStore" Value="UG19"></asp:ListItem>
                                <%--<asp:ListItem Text="Project" Value="UG9"></asp:ListItem>--%>
                            </asp:DropDownList>
                ...
                <div align="center">
                    <asp:GridView ID="gvItemDetails" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Req Qty">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtRate" runat="server" Width="70px" Text='<%#Eval("Qty") %>' Enabled="false"  Font-Bold="False"></asp:TextBox>

                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Forword Qty">
                                <ItemTemplate>
