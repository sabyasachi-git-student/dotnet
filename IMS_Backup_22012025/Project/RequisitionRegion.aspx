<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionRegion.aspx.cs" Inherits="Project_RequisitionRegion" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Material Requisition Region</h3>
            </div>
            <br />
                ...
                <div align="center">
                    <asp:GridView ID="gvItemDetailsApp" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReqTetItemId" HeaderText="ReqItemId" />
                            ...
                            <asp:BoundField DataField="ReqToQty" HeaderText="StockInHand" />
                            <asp:BoundField DataField="POPQty" HeaderText="StockQty" />
                ...
                <div align="center">
                    <asp:GridView ID="gvItemDetails" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReqTetItemId" HeaderText="ReqItemId" Visible="false" />
                            <asp:BoundField DataField="ItemId" HeaderText="ItemId" />
                            <asp:BoundField DataField="Category" HeaderText="Category" />
                            <asp:BoundField DataField="Type" HeaderText="Type" />
                            <asp:BoundField DataField="ItemName" HeaderText="Item Name" />
