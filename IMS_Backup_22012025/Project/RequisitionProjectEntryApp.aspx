<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionProjectEntryApp.aspx.cs" Inherits="Project_RequisitionProjectEntryApp" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Pop Requisition Approval</h3>
            </div>
            <br />
            <div align="center">
                <br />
                <div style="overflow: auto;">
                    ...
                    <dx:ASPxGridView ID="gv_Estimation" runat="server" Theme="Office2003Blue" Width="100%" AutoGenerateColumns="False" KeyFieldName="ReqProId" OnRowCommand="gv_Estimation_RowCommand" DataSourceID="DS_Estimation">
                        <SettingsDetail AllowOnlyOneMasterRowExpanded="True" ShowDetailRow="True" />
                        <Columns>

                            <dx:GridViewCommandColumn ShowInCustomizationForm="True" VisibleIndex="0">
                            </dx:GridViewCommandColumn>
                            <dx:GridViewDataTextColumn FieldName="ReqProId" ReadOnly="True" Caption="ReqProId" ShowInCustomizationForm="True">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="RequisitionDate" ReadOnly="True" Caption="RequisitionDate" ShowInCustomizationForm="True" >
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="RequisitionPurpose" ReadOnly="True" Caption="RequisitionPurpose" ShowInCustomizationForm="True" >
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="ReUserGroupName" ShowInCustomizationForm="True" Caption="Department" >
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="ReUserName" ShowInCustomizationForm="True" Caption="Location"  >
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="ReUser" ShowInCustomizationForm="True" Caption="User"  >
                            </dx:GridViewDataTextColumn>
                    ...
                    <asp:SqlDataSource ID="DS_Estimation" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select ReqProId, convert(varchar,RequisitionDate,103) as RequisitionDate, RequisitionPurpose, Status5 as FromGr, Status4 as Location, ReUserGroupName, ReUserName, Status as ReUser from tbl_RequisitionProject order by rowid desc">
                        <%--<SelectParameters>
