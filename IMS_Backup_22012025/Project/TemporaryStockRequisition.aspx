<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="TemporaryStockRequisition.aspx.cs" Inherits="Project_TemporaryStockRequisition" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Temporary Stock Transfer Requisition</h3>
            </div>
            <br />
            ...
            <div align="center">
                <table cellspacing="15px" align="center">
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold;">Requisition Purpose:<span style="color: red;">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="font-weight: bold;">Requisition to :<span style="color: red;">*</span>
                        </td>
                        <td>
                            <asp:DropDownList runat="server" ID="ddlRequToGrp" AutoPostBack="true" OnTextChanged="ddlRequToGrp_TextChanged" Theme="Office2003Blue" Style="font-size: small;" Height="30px" Width="250px">
                                ...
                                <asp:ListItem Text="POP_FE" Value="UG16"></asp:ListItem>
                    ...
                    <tr>
                        <td style="font-weight: bold;">Days For :<span style="color: red;">*</span>
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtDay" Height="30px" Width="250px"></asp:TextBox>
                        </td>

                        <td style="font-weight: bold;">Project :<span style="color: red;">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="font-weight: bold;">Remarks :<span style="color: red;">*</span>
                        </td>
                        <td>
                ...
                <div align="center">
                    <asp:GridView ID="gvItemDetails" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReqtransItemId" HeaderText="Req trans Item Id" />
                ...
                <table>
                    <tr>
                        ...
                        <td colspan="4" align="center">
                            ...
                            <asp:Button runat="server" ID="btnClear" Text="Cancel" Height="36px" OnClick="btnClear_Click" CssClass="w3-btn w3-orange" />
                        </td>
                    </tr>
                </table>
            </div>
