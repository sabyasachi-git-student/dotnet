...
public partial class Project_FaultyInWarrantyReports : System.Web.UI.Page
{
    ...
    protected void FaultyInWarranty_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        (sender as DevExpress.Web.ASPxGridView).DataSource = dh.getDataTable("SELECT fiwd.* FROM tbl_FaultyInWarrantyDetails fiwd join tbl_FaultyInWarranty fiw on fiwd.FaultyInWarId=fiw.FaultyInWarId where fiw.FaultyInWarId ='" + FaultyInWarId + "'");
