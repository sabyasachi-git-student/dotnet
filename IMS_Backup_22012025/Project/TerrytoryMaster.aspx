<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="TerrytoryMaster.aspx.cs" Inherits="Project_TerrytoryMaster" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Territory Master</h3>
            </div>
            <br />
            ...
            <div align="center">
                <table cellspacing="15px" align="center">
                    <tr>
                        <td style="font-weight: bold;">Territory Name : <span style="color: red;">*</span>
                        </td>
                        <td>
                            <dx:ASPxComboBox ID="txtTerrytoryName" runat="server" AutoPostBack="true" OnTextChanged="txtTerrytoryName_TextChanged"
            ...
            <div align="center">
                <dx:ASPxGridView ID="ASPxGridView1" Theme="Office2003Blue" Font-Bold="true" EnableRowsCache="true" SettingsPager-PageSize="8" EnablePagingGestures="True" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="TerrytoryId" OnRowCommand="ASPxGridView1_RowCommand">
                    <Columns>

                        <dx:GridViewDataTextColumn FieldName="TerrytoryName" Caption="Territory Name" ReadOnly="True" VisibleIndex="1">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select * from  [dbo].[tbl_TerrytoryMaster]  order by rowid desc"></asp:SqlDataSource>
                <br />
            </div>
            <br />
        </div>
