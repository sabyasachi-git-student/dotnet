<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionNOCAppDecline.aspx.cs" Inherits="Project_RequisitionNOCAppDecline" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Region NOC Rejection</h3>
            </div>
            <br />
            <div align="center">
                <br />
                <div style="overflow: auto;">
                    ...
                    <dx:ASPxGridView ID="gv_Estimation" runat="server" Theme="Office2003Blue" Width="100%" AutoGenerateColumns="False" KeyFieldName="ReqNOCId" OnRowCommand="gv_Estimation_RowCommand" DataSourceID="DS_Estimation">
                        <SettingsDetail AllowOnlyOneMasterRowExpanded="True" ShowDetailRow="True" />
                        <Columns>

                            <dx:GridViewCommandColumn ShowInCustomizationForm="True" VisibleIndex="0">
                            </dx:GridViewCommandColumn>
                             <dx:GridViewDataTextColumn FieldName="ReqNOCAppId" ReadOnly="True" Caption="App Id" ShowInCustomizationForm="True">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="ReqNOCId" ReadOnly="True" Caption="Req NOC Id" ShowInCustomizationForm="True">
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn ShowInCustomizationForm="True" Caption="Approve"  Width="0px" Visible="false">
                                <DataItemTemplate>
                                                            ...
                                                            <td align="center" colspan="2">
                                                                <dx:ASPxGridView ID="gv_EstRawMat" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" OnBeforePerformDataSelect="gv_EstRawMat_BeforePerformDataSelect" Theme="Office2003Blue" Width="100%">
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn FieldName="ReqNOCId" ShowInCustomizationForm="True">
                                                                        </dx:GridViewDataTextColumn>
                    ...
                    <asp:SqlDataSource ID="DS_Estimation" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select ReqNOCAppId, ReqNOCId, convert(varchar,RequisitionDate,103) as RequisitionDate, RequisitionPurpose, Status5 as FromGr, Status4 as Location, Status3 as Project, ReUserGroupName, ReUserName, Status as ReUser from tbl_RequisitionNOCApproval where ReqNOCId not in (select ReqNOCId from tbl_RequisitionNOCApp_Reject) and ReqNOCId not in (select ReqId from tbl_MaterialIssue) order by rowid desc">
                        <%--<SelectParameters>
