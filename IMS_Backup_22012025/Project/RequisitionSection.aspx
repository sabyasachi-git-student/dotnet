<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionSection.aspx.cs" Inherits="Project_RequisitionSection" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Material Requisition Of Section</h3>
            </div>
            <br />
               ...
               <br />
                <div align="center">
                    <asp:GridView ID="gvItemDetailsApp" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        AllowPaging="True" OnPageIndexChanging="gvItemDetailsApp_PageIndexChanging" OnRowDataBound="gvItemDetailsApp_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="App & Issue Qty">
                                <ItemTemplate>
                                    <asp:TextBox runat="server" ID="txtItemQty" Width="70px" Text='<%#Eval("Qty") %>' Enabled="false"></asp:TextBox>
