<%@ Page Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="FaultyWarrantyExpiredReport.aspx.cs" Inherits="Project_FaultyWarrantyExpiredReport" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Faulty Warranty Expired Report</h3>
            </div>
            <br />

             <div align="center">
                   
        <dx:ASPxGridView ID="gv_InWarranty" Theme="Office2003Blue" Font-Bold="true" EnableRowsCache="true" SettingsPager-PageSize="8" EnablePagingGestures="True" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="FaultyWarExId"  >
                    <Columns>

                     
                        <dx:GridViewDataTextColumn FieldName="FaultyId" Caption="FaultyId" ReadOnly="True" Settings-AutoFilterCondition="Contains">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="FaultyWarExId" Caption="FaultyWarExId" ReadOnly="True" Settings-AutoFilterCondition="Contains">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="ToRepairer" Caption="ToRepairer" ReadOnly="True" Settings-AutoFilterCondition="Contains">
                        </dx:GridViewDataTextColumn>
         ...
         <Templates>
                <DetailRow>
                    <dx:ASPxGridView ID="FaultyInWarrantyGrid" runat="server" 
                         ...
                         <Columns>
                                <dx:GridViewDataColumn FieldName="FaultyWarExId" Settings-AutoFilterCondition="Contains">
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn FieldName="FaultyWarExDeId" Settings-AutoFilterCondition="Contains">
                                </dx:GridViewDataColumn>
            ...
            <SettingsCustomizationWindow Enabled="True" />
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="SELECT FaultyId,FaultyWarExId,ToRepairer,CorrierName,ConsignNo,convert(varchar,ConsignDate,103) 'ConsignDate',RmaNo,convert(varchar,RmaDate,103) 'RmaDate' FROM tbl_FaultyWarrantyExpired"></asp:SqlDataSource>
