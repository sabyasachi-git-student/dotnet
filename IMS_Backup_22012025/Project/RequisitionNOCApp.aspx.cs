...
public partial class Project_RequisitionNOCApp : System.Web.UI.Page
{
    ...
    protected void gv_Estimation_RowCommand(object sender, ASPxGridViewRowCommandEventArgs e)
    {
        ...
        {
            Response.Redirect(string.Format("~/Project/RequisitionNOCIncharge.aspx?ReqNOCId={0}", ReqNOCId));
