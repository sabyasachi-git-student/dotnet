<%@ Page Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionSecReports.aspx.cs" Inherits="Project_RequisitionSecReports" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Section Requisition Reports</h3>
            </div>
            <br />
            <div align="center">
                <br />
                <div style="overflow: auto;">
                    ...
                    <dx:ASPxGridView ID="gv_Estimation" runat="server" Theme="Office2003Blue" Width="100%" AutoGenerateColumns="False" OnHtmlRowPrepared="gv_Estimation_HtmlRowPrepared" KeyFieldName="ReqSecId"  DataSourceID="DS_Estimation">
                        <SettingsDetail AllowOnlyOneMasterRowExpanded="True" ShowDetailRow="True" />
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="ReqSecId" ReadOnly="True" Caption="ReqSecId" ShowInCustomizationForm="True">
                                                            ...
                                                            <td align="center" colspan="2">
                                                                <dx:ASPxGridView ID="gv_EstRawMat" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" OnBeforePerformDataSelect="gv_EstRawMat_BeforePerformDataSelect" Theme="Office2003Blue" Width="100%">
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn FieldName="ReqSecId" ShowInCustomizationForm="True">
                                                                        </dx:GridViewDataTextColumn>
                    ...
                    <asp:SqlDataSource ID="DS_Estimation" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select ReqSecId, convert(varchar,RequisitionDate,103) as RequisitionDate, RequisitionPurpose, 
Status5 as FromGr, Status4 as Location, ReUserGroupName, ReUserName, Status as ReUser,
case 
when ReqSecId in (select ReqSecId from tbl_RequisitionSecApproval) then 'Approved'
when ReqSecId in (select ReqSecId from tbl_RequisitionSecApp_Reject) then 'Reject'
Else 'Not Chacked' end as Status
 from tbl_RequisitionSection order by rowid desc">
                        <%--<SelectParameters>
