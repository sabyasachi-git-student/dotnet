<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionNOCApp.aspx.cs" Inherits="Project_RequisitionNOCApp" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">NOC Incharge Approval</h3>
            </div>
            <br />
            <div align="center">
                <br />
                <div style="overflow: auto;">
                    ...
                    <asp:SqlDataSource ID="DS_Estimation" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select ReqNOCId, convert(varchar,RequisitionDate,103) as RequisitionDate, RequisitionPurpose, Status5 as FromGr, Status4 as Location, Status3 as Project, 
ReUserGroupName, ReUserName, Status as ReUser from tbl_RequisitionNOC where (Status6 is null or Status6='') order by rowid desc">
                        <%--<SelectParameters>
