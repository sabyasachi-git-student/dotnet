<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="TotalStockReportInUse.aspx.cs" Inherits="Project_TotalStockReportInUse" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Total In Use Reports</h3>
            </div>
            <br />
            <div align="center">
                <table>
                    ...
                    <tr>
                        <td>
                            <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="TotalStockReportInUse"></dx:ASPxGridViewExporter>
                        </td>
                    </tr>
                </table>
            </div>
            <div align="center">
                <dx:ASPxGridView ID="TotalStockReportInUse" runat="server" Theme="Office2003Blue" SettingsPager-PageSize="10" Width="100%" AutoGenerateColumns="False" KeyFieldName="ItemId" DataSourceID="SqlDataSource1">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="BranchName" ReadOnly="True" Caption="PoP Name" ShowInCustomizationForm="True">
                        </dx:GridViewDataTextColumn>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="SELECT distinct rsd.ItemId,im.Category,im.ItemName,im.Make,im.Model,im.WarrantyPeriod,(select Count(Id) from tbl_RackStockInBarCodeDetails where ItemId=rsd.ItemId and BranchID= rsd.BranchId and Status1='InUse') as Qty,im.Unit,hk.TerrytoryId,b.BranchName,u.FullName, u.PhoneNumber FROM tbl_RackStockInBarCodeDetails rss  join tbl_RackStockInDetails rsd on rss.ActualStockInId=rsd.ActualStockInId join tbl_ItemMaster im on im.ItemId=rsd.ItemID  join tbl_Branch b on rsd.BranchId=b.BranchId  left join tbl_HigherKeyMapping hk on b.BranchName=hk.POPId join tbl_User u on rsd.UserId=u.UserName where (select Count(Id) from tbl_RackStockInBarCodeDetails where ItemId=rsd.ItemId and BranchID= rsd.BranchId and Status1='InUse')>0"></asp:SqlDataSource>
            </div>
