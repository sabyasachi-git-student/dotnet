<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionNOCReports.aspx.cs" Inherits="Project_RequisitionNOCReports" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">NOC Requisition Reports</h3>
            </div>
            <br />
            <div align="center">
                   
                <dx:ASPxGridView ID="gv_Estimation" runat="server" Theme="Office2003Blue" Width="100%" AutoGenerateColumns="False" KeyFieldName="ReqNOCId"  DataSourceID="DS_Estimation">
                    ...
                    <asp:SqlDataSource ID="DS_Estimation" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select ReqNOCId, convert(varchar,RequisitionDate,103) as RequisitionDate, RequisitionPurpose, Status3 as Project, 
Status5 as FromGr, Status4 as Location, ReUserGroupName, ReUserName, Status as ReUser,
case 
when ReqNOCId in (select ReqNOCId from tbl_RequisitionNOCApproval) then 'Approved'
when ReqNOCId in (select ReqNOCId from tbl_RequisitionNOCApp_Reject) then 'Reject'
Else 'Not Checked' end as Status
 from tbl_RequisitionNOC order by rowid desc">
                        <%--<SelectParameters>
