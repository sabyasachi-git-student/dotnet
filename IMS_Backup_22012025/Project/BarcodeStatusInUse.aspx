<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="BarcodeStatusInUse.aspx.cs" Inherits="Project_BarcodeStatusInUse" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Material Issue in Use</h3>
            </div>
            <br />
            ...
            <div align="center">
                <table cellspacing="15px" align="center">
                    ...
                    <tr>
                        ...
                        <td colspan="6" align="center">
                            <asp:Button runat="server" ID="btnSave" Text="InUse" OnClick="btnSave_Click" CssClass="w3-btn w3-green" />
                ...
                <div align="center">
                    ...
                    <asp:GridView ID="gv_Barc" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gv_Barc_RowCommand" OnRowDeleting="gv_Barc_RowDeleting" OnRowEditing="gv_Barc_RowEditing" OnPageIndexChanging="gv_Barc_PageIndexChanging">
                        ...
                        <asp:TemplateField HeaderText="Stock In Id">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="SrBarVodeId" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Coder Life">
                            <ItemTemplate>
