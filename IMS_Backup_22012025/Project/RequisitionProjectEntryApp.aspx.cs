...
public partial class Project_RequisitionProjectEntryApp : System.Web.UI.Page
{
    ...
    protected void gv_Estimation_RowCommand(object sender, ASPxGridViewRowCommandEventArgs e)
    {
        ...
        {
            txtSOId.Text = ReqProId;
            Session["ReqProId"] = txtSOId.Text;
        ...
        {
            Response.Redirect(string.Format("~/Project/RequisitionProjectAF.aspx?ReqProId={0}", ReqProId));
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        string UserGroupName = txtUserGroup.Text;
        string BranchName = txtBranchName.Text;
        int SaveItem = ClassRequisitionApproval.ReqProjectAppSave(ReqProId, Date, Remarks, Status1, UserId, UserName, UserGroupId, UserGroupName, BranchName, BranchId, DOE);
        bool UpdateReqPop = DBAccess.SaveData("update tbl_RequisitionProject set Status6 = '" + Status1 + "',  Status7 = convert(datetime,'" + Date + "',103) where ReqProId='" + ReqProId + "'");
        if (SaveItem == 1)
        {
