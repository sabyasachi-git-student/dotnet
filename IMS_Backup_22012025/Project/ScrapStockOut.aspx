<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="ScrapStockOut.aspx.cs" Inherits="Project_ScrapStockOut" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Scrap Stock Out</h3>
            </div>
            <br />
            <div align="center">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold;">Scrap Stock Out Date :<span style="color: red;">*</span></td>
                        <td>
                        ...
                        <td>
                            <asp:Button runat="server" Text="Stock Out" Font-Bold="true" ID="btnSave" CssClass="w3-btn w3-green" Width="118px" OnClick="btnSave_Click" />
