<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionPopReports.aspx.cs" Inherits="Project_RequisitionPopReports" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Pop Requisition Reports</h3>
            </div>
            <br />
            <div align="center">
                <br />
                <div style="overflow: auto;">
                    ...
                    <dx:ASPxGridView ID="gv_Estimation" runat="server" Theme="Office2003Blue" Width="100%" AutoGenerateColumns="False" OnHtmlRowPrepared="gv_Estimation_HtmlRowPrepared" KeyFieldName="ReqPopId"  DataSourceID="DS_Estimation">
                    ...
                    <asp:SqlDataSource ID="DS_Estimation" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select ReqPopId, convert(varchar,RequisitionDate,103) as RequisitionDate, RequisitionPurpose, 
Status5 as FromGr, Status4 as Location, ReUserGroupName, ReUserName, Status as ReUser,
case 
when ReqPopId in (select ReqPopId from tbl_RequisitionPopApproval) then 'Approved'
when ReqPopId in (select ReqPopId from tbl_RequisitionPopApp_Reject) then 'Reject'
Else 'Not Chacked' end as Status
 from tbl_RequisitionPop order by rowid desc">
                        <%--<SelectParameters>
