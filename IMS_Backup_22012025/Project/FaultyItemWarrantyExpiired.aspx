<%@ Page Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="FaultyItemWarrantyExpiired.aspx.cs" Inherits="Project_FaultyItemWarrantyExpiired" %>
    ...
    <div class="w3-container">
        <div class="w3-panel w3-card-4 w3-white">
            <div class="w3-blue w3-card-4">
                <h3 align="center">Faulty Item Warranty Expired</h3>
            </div>
            <br />
            ...
            <div align="center">
                ...
                <%--<table align="center">
                    <tr>
                        <td colspan="4" align="center">
                            <asp:Button runat="server" ID="btnChooseFaultyItem" Text="Choose Item"  CssClass="w3-btn w3-blue" OnClick="btnChooseFaultyItem_Click" />
                        </td>
                    </tr>
                </table>--%>
                <br />
               <table cellspacing="15px" align="center" >
                   ...
                   <tr>
                       <td style="font-weight: bold;">To Repairer :
                        </td>
                        <td>
                            <dx:ASPxComboBox ID="ddlToRepairer" runat="server"
                                Height="30px" Width="250px"
                                ValueField="ToRepairer" TextField="ToRepairer" Theme="Office2003Blue"
                            ...
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                ConnectionString="<%$ ConnectionStrings:Profit %>"
                                SelectCommand="select Distinct ToRepairer from tbl_FaultyWarrantyExpired"></asp:SqlDataSource>
                            </td>
                       ...
                       <tr id="Tr1" runat="server">
                        ...
                        <td>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                ConnectionString="<%$ ConnectionStrings:Profit %>"
                                SelectCommand="select Distinct CorrierName from tbl_FaultyWarrantyExpired"></asp:SqlDataSource>
                            </td>
...
<ItemStyle Width="25px"></ItemStyle>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Button runat="server" ID="Button2" Text="Save" OnClick="btnSave_Click" CssClass="w3-btn w3-green" /><%----%>
                            <asp:Button runat="server" ID="Button3" Text="Clear" OnClick="btnClear_Click" CssClass="w3-btn w3-orange" /><%----%>
                        </td>
                    </tr>
                </table>  
            </div>
