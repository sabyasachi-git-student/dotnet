<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Project.master" AutoEventWireup="true" CodeFile="RequisitionPopApp.aspx.cs" Inherits="Project_RequisitionPopApp" %>
        ...
        <div class="w3-panel w3-card-4 w3-white">
            ...
            <div align="center">
                ...
                <div style="overflow: auto;">
                    ...
                    <dx:ASPxGridView ID="gv_Estimation" runat="server" Theme="Office2003Blue" Width="100%" AutoGenerateColumns="False" KeyFieldName="ReqPopId" OnRowCommand="gv_Estimation_RowCommand" DataSourceID="DS_Estimation">
                        <SettingsDetail AllowOnlyOneMasterRowExpanded="True" ShowDetailRow="True" />
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="ReqPopId" ReadOnly="True" Caption="ReqPopId" ShowInCustomizationForm="True">
                            ...
                            <dx:GridViewDataTextColumn FieldName="FromGr" ShowInCustomizationForm="True" Caption="Department" >
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Location" ShowInCustomizationForm="True" Caption="Location"  >
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="UserId" ShowInCustomizationForm="True" Caption="User"  >
                            </dx:GridViewDataTextColumn>

                            <dx:GridViewDataTextColumn ShowInCustomizationForm="True" Caption="Approve"  Width="0px">
                                <DataItemTemplate>
                                    <asp:Button ID="btnApprove" runat="server" CommandName="Approve" Text="Approve & Forward" CssClass="w3-btn w3-orange" />
                                </DataItemTemplate>
                            </dx:GridViewDataTextColumn>
                                                            ...
                                                            <td align="center" colspan="2">
                                                                <dx:ASPxGridView ID="gv_EstRawMat" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" OnBeforePerformDataSelect="gv_EstRawMat_BeforePerformDataSelect" Theme="Office2003Blue" Width="100%">
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataTextColumn FieldName="ReqPopId" ShowInCustomizationForm="True">
                                                                        </dx:GridViewDataTextColumn>
                    ...
                    <asp:SqlDataSource ID="DS_Estimation" runat="server" ConnectionString="<%$ ConnectionStrings:Profit %>" SelectCommand="select ReqPopId, convert(varchar,RequisitionDate,103) as RequisitionDate,
 RequisitionPurpose, Status5 as FromGr,UserId, Status4 as Location, ReUserGroupName, UserID, ReUserName,  Status as ReUser from tbl_RequisitionPop where ReUserId = @BranchId and (Status6 is null or Status6='')  order by rowid desc">
                        <SelectParameters>
